...
Mobile.setText(findTestObject('Search Product/searchBox'), 'computer', 0)

MobileDriverFactory.getDriver().pressKey(new KeyEvent(AndroidKey.ENTER))

Mobile.verifyElementExist(findTestObject('Search Product/No items found. Please specify your searching criteria'), 10)
